...
namespace {
   ...
   TEST_F(PointTest, Interpolate)
   {
      ...
      EXPECT_FLOAT_EQ(285.378f, r.x());
      EXPECT_FLOAT_EQ(664.242f, r.y());

      r = Point::interpolate(p1, p2, 0.78f);
      EXPECT_FLOAT_EQ(79.0800f, r.x());
      EXPECT_FLOAT_EQ(174.12f, r.y());
   ...
   TEST_F(PointTest, Polar)
   {
      ...
      EXPECT_FLOAT_EQ(182.7208f, r.x());
      EXPECT_FLOAT_EQ(147.4271f, r.y());
   }
